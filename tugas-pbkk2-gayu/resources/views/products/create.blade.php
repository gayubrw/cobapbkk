...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" class="w-full px-3 py-2" required>
        </div>
        <div class="mb-4">
            <label for="price" class="block text-white">Harga:</label>
            <input type="number" name="price" class="w-full px-3 py-2" required>
        </div>
        <div class="mb-4">
            <label for="stock" class="block text-white">Stok:</label>
            <input type="number" name="stock" class="w-full px-3 py-2" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="url" name="image_url" class="w-full px-3 py-2">
        </div>
